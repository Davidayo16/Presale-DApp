  ...
  return (
    <div className="w-full h-full p-3 sm:p-4 lg:p-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6">
        ...
        >
          <h2 className="flex items-center mb-3 text-base sm:text-lg font-semibold text-[var(--color-text-header)]">
        ...
        >
          ...
          <div className="pointer-events-none opacity-60">
            <p className="text-[#22c55e] text-xs sm:text-sm">Whitelisted</p>
            <p className="mt-2 text-xs text-[var(--color-text-sub)]">
        ...
        >
          ...
          <p className="mt-2 text-xs text-[var(--color-text-sub)] opacity-60">
        ...
        >
          ...
          <div className="space-y-3 pointer-events-none opacity-60">
            <div className="flex items-center justify-between">
              <span className="flex items-center text-xs sm:text-sm text-[var(--color-text-body)]">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-sm text-[var(--color-text-body)]">
