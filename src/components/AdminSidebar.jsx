...
const menuItems = [
  ...
  { name: "Participants", href: "/admin/participants", icon: UserGroupIcon },
  { name: "Controls", href: "/admin/controls", icon: CogIcon },
  { name: "Analytics", href: "/admin/funds", icon: PresentationChartBarIcon },
      ...
      >
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center text-xl font-semibold">
            <Link to="/" className="block h-12 cursor-pointer">
              <img
                src="/images/logo.png"
                alt="Logo"
